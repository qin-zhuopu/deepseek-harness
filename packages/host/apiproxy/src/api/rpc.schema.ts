...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('workspace-prompt-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('workspace-prompt-rejected'), message: z.string(), details: z.object({ prompt: z.string() }) }),
