...
export const zh = {
  ...
  'workspace.add': '添加工作区',
  'workspace.createFromPrompt': '按描述创建工作区',
  'workspace.createFromPrompt.title': '按描述创建工作区',
  'workspace.createFromPrompt.placeholder': '描述你想创建的这个工作区，例如：一个用于分析每日销售数据的数据科学项目…',
  'workspace.createFromPrompt.hint': '将根据你的描述在 /workspaces 下生成一个目录名称，并直接进入该工作区。',
  'workspace.createFromPrompt.submit': '创建',
  'workspace.createFromPrompt.creating': '正在创建…',
...
export const en = {
  ...
  'workspace.createFromPrompt': 'Create workspace from description',
  'workspace.createFromPrompt.title': 'Create workspace from description',
  'workspace.createFromPrompt.placeholder': 'Describe the workspace you want to create, e.g. a data-science project to analyze daily sales numbers…',
  'workspace.createFromPrompt.hint': 'A directory name will be derived from your description under /workspaces, and you will be taken straight into it.',
  'workspace.createFromPrompt.submit': 'Create',
  'workspace.createFromPrompt.creating': 'Creating…',
